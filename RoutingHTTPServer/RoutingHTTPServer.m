...
@implementation RoutingHTTPServer {
	NSMutableDictionary<NSString*, NSMutableArray<Route*>*> *routes;
	NSMutableDictionary<NSString*, NSString*> *defaultHeaders;
	NSMutableDictionary<NSString*, NSString*> *mimeTypes;
